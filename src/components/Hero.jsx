    ...
    return (
        <section id="home" className="hero">
            <div className="hero-content animate">
                <span className="subtitle">AroBox Packing</span>
                <h1 className="hero-title">Premium Quality Boxes<br /><span>For Every Need.</span></h1>
                <p className="hero-text">Presented by AroBox Packing Team. We manufacture high-strength, sustainable corrugated boxes tailored for your e-commerce, retail, and logistical needs.</p>
